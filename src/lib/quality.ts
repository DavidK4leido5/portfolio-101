...
export const QUALITY: Record<Tier, TierConfig> = {
  desktop: {
    ...
    ambient: 160, dpr: 2, bloom: true, bloomIntensity: 0.42, ca: true, grain: true, grainOpacity: 0.028, travelSec: 2.8,
  },
  tablet: {
    maxConnections: 3200, neighbors: 4, maxDist: 0.4, rebuildMs: 800,
    ambient: 50, dpr: 1.5, bloom: true, bloomIntensity: 0.32, ca: false, grain: true, grainOpacity: 0.02, travelSec: 2.4,
  },
  mobile: {
    maxConnections: 1600, neighbors: 3, maxDist: 0.44, rebuildMs: 950,
    ambient: 0, dpr: 1, bloom: false, bloomIntensity: 0, ca: false, grain: false, grainOpacity: 0, travelSec: 2.0,
  },
}
